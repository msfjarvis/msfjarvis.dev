...
{{<figure src="aps-august-release-single-url-field.webp" alt="Single URL field in repository information" >}}
...
{{<figure src="aps-august-release-xkpasswd.webp" alt="XkPasswd generator with the new symbol/number append option" >}}
...
{{<figure src="aps-august-release-subdir-key-support.webp" alt="Create folder dialog but key selection checkbox" >}}
...
{{<figure src="aps-august-release-missing-openkeychain.webp" alt="OpenKeychain installation prompt" >}}
