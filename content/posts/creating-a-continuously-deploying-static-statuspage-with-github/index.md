...
{{<figure src="statuspage_cname_record.webp" alt="CNAME record for status.msfjarvis.dev at Cloudflare" >}}
...
{{<figure src="statuspage_github_repo.webp" alt="GitHub repository for our status page" >}}
...
{{<figure src="statuspage_cname_file.webp" alt="CNAME file in repository" >}}
