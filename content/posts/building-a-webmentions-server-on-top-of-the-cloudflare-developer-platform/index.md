...
Equipped with superpowers and not being particularly happy with the current state of the Webmentions server, I decided to throw all the existing code away and rewrite it following the W3C draft closely and have extensive tests from the very beginning.
