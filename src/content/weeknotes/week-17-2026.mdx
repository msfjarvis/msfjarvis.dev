...
import chicken_popcorn_at_cafe_grey from '../../content/images/weeknotes/week-17-2026/chicken-popcorn-at-cafe-grey.webp';
import dangerous_pulav from '../../content/images/weeknotes/week-17-2026/dangerous-pulav.webp';
import knock_off_mascots_at_michael from '../../content/images/weeknotes/week-17-2026/knock-off-mascots-at-michael.webp';
import michael from '../../content/images/weeknotes/week-17-2026/michael.webp';
import nacho_dip_at_home from '../../content/images/weeknotes/week-17-2026/nacho-dip-at-home.webp';
import nachos_at_cafe_grey from '../../content/images/weeknotes/week-17-2026/nachos-at-cafe-grey.webp';
...
<Figure src={nachos_at_cafe_grey} alt="A white ceramic plate with a pile of nachos in the middle. There's melty white cheese all over the top." title="These nachos were tasty but also obviously fresh out of a bag." />

<Figure src={chicken_popcorn_at_cafe_grey} alt="A plate of fried chicken popcorn with small bowls of mayonnaise and ketchup. There's a lemon half sitting on top of the chicken, which itself is on thin bed of lettuce." title="Can't really complain about fried chicken." />
...
<Figure src={michael} alt="A scene from the movie Michael showing him singing on stage in a black jacket." title="The picture's a little lopsided because of letterboxing, my positioning and most importantly my ineptitude." />
...
<Figure src={knock_off_mascots_at_michael} alt="A slightly blurry zoomed in photo of the front of a movie theater, showing mascots in costumes: Hello Kitty, Mickey Mouse and a nondescript mouse I cannot identify immediately." title="For how random this was, the mascots were having fun with it." />
...
<Figure src={dangerous_pulav} alt="A bowl containing pulav, an Indian rice dish that's typically pressure cooked rice with misc veggies and spices. Ours doesn't look particularly different from what you'd expect, but the flavor was abysmal. We fucked up big time here." title="This thing was genuinely close to being radioactive." />
