...
import hugo_metadata_correct_meta from '../../content/images/posts/adding-social-metadata-to-your-hugo-sites/hugo_metadata_correct_meta.webp';
import hugo_metadata_no_meta from '../../content/images/posts/adding-social-metadata-to-your-hugo-sites/hugo_metadata_no_meta.webp';
...
<Figure src={hugo_metadata_no_meta} alt="No metadata" />

<Figure src={hugo_metadata_correct_meta} alt="Correct metadata" />
