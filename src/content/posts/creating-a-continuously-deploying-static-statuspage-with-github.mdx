...
<Figure src="/posts/creating-a-continuously-deploying-static-statuspage-with-github/statuspage_cname_record.webp" alt="CNAME record for status.msfjarvis.dev at Cloudflare" />
...
<Figure src="/posts/creating-a-continuously-deploying-static-statuspage-with-github/statuspage_github_repo.webp" alt="GitHub repository for our status page" />
...
<Figure src="/posts/creating-a-continuously-deploying-static-statuspage-with-github/statuspage_cname_file.webp" alt="CNAME file in repository" />
