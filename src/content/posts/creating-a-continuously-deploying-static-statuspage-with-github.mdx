...
import statuspage_cname_file from '../../content/images/posts/creating-a-continuously-deploying-static-statuspage-with-github/statuspage_cname_file.webp';
import statuspage_cname_record from '../../content/images/posts/creating-a-continuously-deploying-static-statuspage-with-github/statuspage_cname_record.webp';
import statuspage_github_repo from '../../content/images/posts/creating-a-continuously-deploying-static-statuspage-with-github/statuspage_github_repo.webp';
...
<Figure src={statuspage_cname_record} alt="CNAME record for status.msfjarvis.dev at Cloudflare" />
...
<Figure src={statuspage_github_repo} alt="GitHub repository for our status page" />
...
<Figure src={statuspage_cname_file} alt="CNAME file in repository" />
