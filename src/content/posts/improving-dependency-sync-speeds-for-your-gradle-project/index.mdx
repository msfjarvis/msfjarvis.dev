...
<Figure
  src={run_configuration}
  title="The Android Studio Run configuration window configured with the task ':android:dependencies --refresh-dependencies'"
/>
...
<Figure
  src={download_info}
  title="Download info window showing a list of network requests and their sources while the task is running"
/>
...
<Figure
  src={before_fixes}
  title="The Android Studio Dependency Sync window, showing a total sync duration of 5 minutes and 56 seconds of which 1 minute and 30 seconds went into failed network requests"
/>
...
<Figure
  src={after_fixes}
  title="The Android Studio Dependency Sync window, now showing the total sync taking only 3 minutes and 17 seconds with 0 failed requests"
/>
