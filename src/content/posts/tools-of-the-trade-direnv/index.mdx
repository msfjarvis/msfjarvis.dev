...
<Asciinema id="qMkuyVjPSkhNqO6Jo0eQnLiyt" />
...
<Asciinema id="irkZWRh00gFVIcH41BRcOvowm" />

Stripping entries from `$PATH`:

<Asciinema id="vbzolwrYnXzBFvhAqMJEFBNRv" />

Adding entries into `$PATH`:

<Asciinema id="C1EhhAoy1y3vSwJaIc0R8o0RY" />
