...
date: 2026-07-14T12:30:00+05:30
lastmod: 2026-07-14T12:30:00+05:30
...
Zipline offered everything I was looking for, and since I was predominantly using Kotlin/JS capable libraries for the HTML parsing it seemed like a no-brainer to give this a go. What follows is a deep rabbit hole dive of fighting code size issues, stack overflows, and cache invalidation problems.
...
Here's how an instance of the `User` object is serialized using the new serialization code.
...
`current` is a symlink to a timestamped directory containing the compiled Zipline artifacts. The size of individual releases is relatively tiny so I keep all previous releases around, making it easy to roll back during one of those aforementioned fuck ups.
