...
<Figure src="/posts/aps-august-release/aps-august-release-single-url-field.webp" alt="Single URL field in repository information" />
...
<Figure src="/posts/aps-august-release/aps-august-release-xkpasswd.webp" alt="XkPasswd generator with the new symbol/number append option" />
...
<Figure src="/posts/aps-august-release/aps-august-release-subdir-key-support.webp" alt="Create folder dialog but key selection checkbox" />
...
<Figure src="/posts/aps-august-release/aps-august-release-missing-openkeychain.webp" alt="OpenKeychain installation prompt" />
