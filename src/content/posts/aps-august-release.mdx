...
import aps_august_release_missing_openkeychain from '../../content/images/posts/aps-august-release/aps-august-release-missing-openkeychain.webp';
import aps_august_release_single_url_field from '../../content/images/posts/aps-august-release/aps-august-release-single-url-field.webp';
import aps_august_release_subdir_key_support from '../../content/images/posts/aps-august-release/aps-august-release-subdir-key-support.webp';
import aps_august_release_xkpasswd from '../../content/images/posts/aps-august-release/aps-august-release-xkpasswd.webp';
...
<Figure src={aps_august_release_single_url_field} alt="Single URL field in repository information" />
...
<Figure src={aps_august_release_xkpasswd} alt="XkPasswd generator with the new symbol/number append option" />
...
<Figure src={aps_august_release_subdir_key_support} alt="Create folder dialog but key selection checkbox" />
...
<Figure src={aps_august_release_missing_openkeychain} alt="OpenKeychain installation prompt" />
