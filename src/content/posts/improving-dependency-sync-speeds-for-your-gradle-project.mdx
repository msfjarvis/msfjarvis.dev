...
<Figure src="/posts/improving-dependency-sync-speeds-for-your-gradle-project/run-configuration.webp" title="The Android Studio Run configuration window configured with the task ':android:dependencies --refresh-dependencies'" />
...
<Figure src="/posts/improving-dependency-sync-speeds-for-your-gradle-project/download-info.webp" title="Download info window showing a list of network requests and their sources while the task is running" />
...
<Figure src="/posts/improving-dependency-sync-speeds-for-your-gradle-project/before-fixes.webp" title="The Android Studio Dependency Sync window, showing a total sync duration of 5 minutes and 56 seconds of which 1 minute and 30 seconds went into failed network requests" />

### After

<Figure src="/posts/improving-dependency-sync-speeds-for-your-gradle-project/after-fixes.webp" title="The Android Studio Dependency Sync window, now showing the total sync taking only 3 minutes and 17 seconds with 0 failed requests" />
