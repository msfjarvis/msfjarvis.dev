...
import goaccess_terminal from '../../content/images/posts/serverside-stats-with-goaccess/goaccess_terminal.webp';
...
<Figure src={goaccess_terminal} alt="Goaccess in the terminal" />
