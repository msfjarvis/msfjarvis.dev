...
categories:
  - journaling
lastmod: "2025-03-17T05:38:37.000Z"
draft: false
deleted: false
---
...
My existing workflow on Android involved manually committing and pushing changes to my graph/vault via [MGit](https://github.com/maks/MGit) which was too many clicks in the MGit app and was getting a little frustrating over time. I [asked on the Fediverse](https://masto-archive.msfjarvis.dev/@msfjarvis/114136599118536735) if someone was aware of a newer Git client for Android and very quickly discovered [PuppyGit](https://github.com/catpuppyapp/PuppyGit).
