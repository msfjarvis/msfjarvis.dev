...
import aps_october_release_gpg_key_selection from '../../content/images/posts/aps-october-release/aps-october-release-gpg-key-selection.webp';
...
<Figure src={aps_october_release_gpg_key_selection} alt="GPG key selection screen from the APS October release" />
...
{/*![App launch screen showing the repository being synced](/posts/aps-october-release/aps-october-release-syncing-repository.webp)*/}
