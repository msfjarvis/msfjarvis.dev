...
<Figure src="/posts/overengineering-an-obsidian-dashboard-to-get-better-at-marvel-snap/template.webp" alt="Obsidian's GUI for the frontmatter given above, of note is the date picker and the 'chips' pattern for entering list values for the locations field" />
...
<Figure src="/posts/overengineering-an-obsidian-dashboard-to-get-better-at-marvel-snap/daily-dashboard.webp" alt="A table with a single row showing the total games, the wins, the losses, the retreats and the net cube change for the day" />

This can also be extended to cover the past week

<Figure src="/posts/overengineering-an-obsidian-dashboard-to-get-better-at-marvel-snap/weekly-dashboard.webp" alt="A table with a single row showing the total games, the wins, the losses, the retreats and the net cube change for the week" />
...
<Figure src="/posts/overengineering-an-obsidian-dashboard-to-get-better-at-marvel-snap/deck-performance.webp" alt="A table showing the decks I played in each row and their respective game counts, win rate and net cubes statistics" />
...
<Figure src="/posts/overengineering-an-obsidian-dashboard-to-get-better-at-marvel-snap/locations.webp" alt="A table of every location with its name, number of times I played there, my win rate and the net cubes" />
