...
import actions_tips_tricks_commit_hash from "./actions_tips_tricks_commit_hash.webp";
...
> <sub>
>   This particular matrix is for Rust, to test a codebase across Windows,
>   Ubuntu, and macOS using the Rust stable, beta, and nightly toolchains.
> </sub>
...
<Figure
  src={actions_tips_tricks_commit_hash}
  alt="A tag along with its commit hash"
/>

> <sub>
>   Here, the commit hash is feb985e. Ideally, you want to click that link and
>   copy the full hash from the URL
> </sub>
