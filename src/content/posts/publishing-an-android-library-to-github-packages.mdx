...
import github_packages_support_response from '../../content/images/posts/publishing-an-android-library-to-github-packages/github_packages_support_response.webp';
...
<Figure src={github_packages_support_response} alt="GitHub support reply about authentication requirement for packages" />
