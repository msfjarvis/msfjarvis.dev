...
<Figure src="/posts/publishing-an-android-library-to-github-packages/github_packages_support_response.webp" alt="GitHub support reply about authentication requirement for packages" />
