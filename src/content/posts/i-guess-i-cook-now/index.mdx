...
import burrito_pan from "./burrito-pan.webp";
import day_1_hummus_result from "./day-1-hummus-result.webp";
import day_1_hummus from "./day-1-hummus.webp";
import the_birth_of_a_burrito from "./the-birth-of-a-burrito.webp";
...
<Figure
  src={day_1_hummus}
  alt="A food processor with blended chickpeas inside it, and a spatula sitting a little to the left that has clearly been inside the food processor. You can still see a bunch of solid chickpeas that are yet to be grounded down, floating in a slightly off white paste of ground chickpeas."
  title="This was a bit of an arm workout not gonna lie"
/>

<Figure
  src={day_1_hummus_result}
  alt="A small metal plate with some hummus that I've done a poor job of garnishing with some olive oil, red chilli powder and cumin powder."
  title="4/10 plating but 8/10 flavour, I'll take it."
/>
...
<Figure
  src={the_birth_of_a_burrito}
  alt="Two tortillas on a metal plate, overlapping around 30% with a big pile of fillings on top. The internet told me this is the right way to make a burrito with two wraps."
  title="The internet told me this is how you make a burrito with two wraps."
/>
<Figure
  src={burrito_pan}
  alt="A burrito being lightly grilled on a pan. Shocking it has not split open its guts all over the place."
  title="One of the rare few burritos that stayed in one piece when we grilled them."
/>
