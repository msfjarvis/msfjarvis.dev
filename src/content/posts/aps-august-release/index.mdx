...
<Figure
  src={aps_august_release_single_url_field}
  alt="Single URL field in repository information"
/>
...
<Figure
  src={aps_august_release_xkpasswd}
  alt="XkPasswd generator with the new symbol/number append option"
/>
...
<Figure
  src={aps_august_release_subdir_key_support}
  alt="Create folder dialog but key selection checkbox"
/>
