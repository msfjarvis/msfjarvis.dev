...
import aps_m2_gallery from '../../content/images/posts/migrating-aps-to-material-you/aps_m2_gallery.webp';
import aps_m3_gallery from '../../content/images/posts/migrating-aps-to-material-you/aps_m3_gallery.webp';
...
<Figure src={aps_m2_gallery} alt="Screenshot gallery of a few APS screens before the Material 3 migration" />

### After

<Figure src={aps_m3_gallery} alt="Screenshot gallery of a few APS screens after the Material 3 migration" />
