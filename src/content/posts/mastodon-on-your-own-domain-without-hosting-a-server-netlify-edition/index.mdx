...
Similar to Maarten, I first obtained my current Fediverse identity from the Mastodon server I am on: [fantastic.earth](https://fantastic.earth).

```json
➜ curl -s https://fantastic.earth/.well-known/webfinger?resource=acct:msfjarvis@fantastic.earth | jq .
{
  "subject": "acct:msfjarvis@fantastic.earth",
  "aliases": [
    "https://fantastic.earth/@msfjarvis",
    "https://fantastic.earth/users/msfjarvis"
  ],
  "links": [
    {
    ...
    },
    {
      ...
      "href": "https://fantastic.earth/users/msfjarvis"
    },
    {
      "rel": "http://ostatus.org/schema/1.0/subscribe",
      "template": "https://fantastic.earth/authorize_interaction?uri={uri}"
    }
  ]
}
```
...
export default async (request: Request, context: Context) => {
  ...
  if (resourceParam === null) {
    ...
    return context.json({
      subject: "acct:msfjarvis@fantastic.earth",
      aliases: ["https://fantastic.earth/@msfjarvis", "https://fantastic.earth/users/msfjarvis"],
      links: [
        {
          rel: "http://webfinger.net/rel/profile-page",
          type: "text/html",
