...
> [!WARNING]
> 05/05/2026: Since writing this post I've come to realize that caddy-security very frequently makes subtle breaking changes, and you only figure out the migration by creating an issue yourself or reading the GitHub issue someone else created. That's far too much churn than I wish to have in security-sensitive software. I will personally be moving to Authelia and LLDAP in the near future to leverage its first party support for forward and reverse auth, and a more stable release cycle.
