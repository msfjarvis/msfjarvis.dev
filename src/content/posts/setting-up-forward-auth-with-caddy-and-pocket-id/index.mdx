...
> WARNING (added 05/05/2026): Since writing this post I've come to realize that caddy-security very frequently makes subtle breaking changes that are hard to parse without directly talking to the maintainer after every release which is not a problem I wish to have. I will personally be moving to Authelia and LLDAP in the near future to leverage its first party support for forward and reverse auth, and a more stable release cycle.
