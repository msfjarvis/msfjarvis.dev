...
import obsidian_weeknotes from '../../content/images/notes/obsidian-weeknotes.webp';
...
<Figure src={obsidian_weeknotes} alt="An Obsidian page with the title 2025-W50 and listing two journal entries from today: Me writing about my Droidcon India 2025 experience and a mention of me finishing my second run of the game Dispatch." title="Week 50 roundup with entries from Sunday" />
