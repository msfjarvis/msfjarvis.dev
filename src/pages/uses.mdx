...
My terminal-based text editor of choice is currently [micro](https://micro-editor.com/), but I'm looking for a better non-modal option.
...
- 128GB Google Pixel 4a running LineageOS 23.2
